...
docker push ${TERRAMA2_DOCKER_REGISTRY}/${COMPOSE_PROJECT_NAME}-satalertas-server:${SATALERTAS_TAG}
_terrama2_satalertas_server_code=$?

# TerraMA² SatAlertas client
docker push ${TERRAMA2_DOCKER_REGISTRY}/${COMPOSE_PROJECT_NAME}-satalertas-client:${SATALERTAS_TAG}
