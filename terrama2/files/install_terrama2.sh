...
curl -O http://www.dpi.inpe.br/jenkins-data/terrama2/installers/linux/TerraMA2-${TERRAMA2_TAG}-releaselinux-x64-Ubuntu-16.04.deb --silent
...
dpkg -i TerraMA2-${TERRAMA2_TAG}-linux-x64-Ubuntu-16.04.deb
rm TerraMA2-${TERRAMA2_TAG}-linux-x64-Ubuntu-16.04.deb
